        ...
        <div className="max-w-7xl mx-auto px-6 md:px-12 flex items-center justify-between">
          ...
          >
            ...
            <div className="flex flex-col leading-tight">
              <span className="font-display font-bold text-[13px] sm:text-[14px] tracking-[0.15em] text-green-900 group-hover:text-green-600 transition-colors">
                KIOS BUKU
              </span>
              <span className="text-[7.5px] tracking-[0.2em] text-green-600 uppercase font-semibold">
          ...
          <div className="flex items-center space-x-3">
            <a
              ...
              className="hidden sm:flex items-center space-x-1.5 px-5 py-2.5 rounded-full bg-green-600 hover:bg-green-700 text-white text-[10px] tracking-widest uppercase font-bold transition-all cursor-pointer shadow-[0_4px_15px_rgba(22,163,74,0.25)] group"
            >
            ...
            <button
              ...
              className="lg:hidden p-2.5 rounded-xl border border-green-200 text-green-700 hover:bg-green-50 transition-colors cursor-pointer"
